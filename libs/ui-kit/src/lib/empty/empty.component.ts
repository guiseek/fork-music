...
const EMPTY_IMAGES = {
  ...
  original: 'https://gw.alipayobjects.com/mdn/miniapp_social/afts/img/A*pevERLJC9v0AAAAAAAAAAABjAQAAAQ/original'
}
...
export class EmptyComponent implements OnInit {
  @Input() imageURL: string | SafeResourceUrl
